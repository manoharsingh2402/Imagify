...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <motion.h1 className='text-4xl max-w-[300px] sm:text-7xl lg:text-5xl sm:max-w-[590px] mx-auto mt-10 text-center'>
      ...
      className="sm:text-lg text-white bg-black w-auto mt-8 px-12 py2.5 flex items-center gap-2 rounded-full"
      ...
      > 
        Generate Images 
        <img className="h-12" src={assets.star_group} alt=""></img>
      </motion.button> 
      <motion.div 
      initial={{opacity:0}} 
      animate={{opacity:1}}
